 ...
 */
class Version20171206161707 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE post (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, message VARCHAR(140) NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
