 ...
 */
class Version20171206172323 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__result AS SELECT id, cup, team1player1, team1player2, team2player1, team2player2 FROM result');
        $this->addSql('DROP TABLE result');
        $this->addSql('CREATE TABLE result (id INTEGER NOT NULL, cup INTEGER DEFAULT NULL, team1player1 INTEGER DEFAULT NULL, team1player2 INTEGER DEFAULT NULL, team2player1 INTEGER DEFAULT NULL, team2player2 INTEGER DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO result (id, cup, team1player1, team1player2, team2player1, team2player2) SELECT id, cup, team1player1, team1player2, team2player1, team2player2 FROM __temp__result');
        $this->addSql('DROP TABLE __temp__result');
        $this->addSql('CREATE INDEX IDX_136AC113B79D50E4 ON result (cup)');
        $this->addSql('CREATE INDEX IDX_136AC1138484A0A4 ON result (team1player1)');
